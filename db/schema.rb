...
ActiveRecord::Schema[7.0].define(version: 2022_05_09_214502) do
  ...
  create_table "reservations", force: :cascade do |t|
    ...
    t.index ["psychologist_id"], name: "index_reservations_on_psychologist_id"
  ...
  add_foreign_key "reservations", "psychologists"
